...
CREATE TABLE `vote` (
  ...
  KEY `vote_post_idx` (`post_id`),
  CONSTRAINT `vote_post` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
LOAD DATA INFILE '/var/lib/mysql-files/users.csv' IGNORE
INTO TABLE user 
